...
HD_PWD='A:/doug/Documents/GitHub/cmpe125labs/Lab 4/alu/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_inst.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_inst.tcl -notrace
