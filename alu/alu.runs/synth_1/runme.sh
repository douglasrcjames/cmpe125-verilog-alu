...
HD_PWD='A:/doug/Documents/GitHub/cmpe125labs/Lab 4/alu/alu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_inst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_inst.tcl
